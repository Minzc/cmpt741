...
public class StringUtil {
    ...
    public static final String DELIMIT_1ST = "|"; // first-priority delimiter
    ...
    public static String genMD5Val(String string) {
        ...
        try {
            ...
            for (byte aMd5Val : md5Val) {
                int val = ((int) aMd5Val) & 0xff;
                if (val < 16)
                    sBuilder.append("0");
     ...
     *
     * @param Split_Sign enum ==> Split sign
     * @param String     ... args
     * @return String
     */
    ...
    public static String getArrayString(Split_Sign sign,
        ...
        for (String senExpressionString : senExpressionStrings) {
            outString.append(senExpressionString + splitStr);
        }
    ...
    public static <T> String mergeArray(T[] items, String sep) {
        StringBuilder sb = new StringBuilder();
        for (int i = 0; i < items.length - 1; i++) {
            sb.append(items[i]).append(sep);
        }
